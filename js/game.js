class Game {
	...
	create_main_game(){
		...
		game_data['options_holder'].setVisible(false);
		game_data['shop_holder'].setVisible(false);
	...
	start_game() {
		game_data['options_holder'].setVisible(true);
		game_data['shop_holder'].setVisible(true);
	...
	handler_event(params) {
	  switch (params['event']) {
			...
			case 'level_quit':
				...
				break;
			case 'update_back':
				this.game_map.update_back(params);
				this.game_play.update_back(params);
				this.shop.update_back(params);
				break;
			case 'destroy_level':
			...
			case 'reset_music':
				...
				this.game_map.reset_music(params);
				break;
	  default:
